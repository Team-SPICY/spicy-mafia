...
SECRET_KEY = 'cu&%k32^+v++q(qbq&nc23@9^l-gyv#6*nm@^sj*@)8t)1z#a6'
...
#add CORS to allow axios to talk to django channels/restframework https://github.com/adamchainz/django-cors-headers
